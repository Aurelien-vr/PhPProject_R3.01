...
<form action="ajout_joueurs.php" method="POST">
    <div id="ajoutJoueur">
        Numéro de Licence* : <input type="text" name="numLicence" class="formulaireInsertion" required maxlength="50" value="<?php echo htmlspecialchars($numLicence); ?>"><br/>
        Nom* : <input type="text" name="nom" class="formulaireInsertion" required maxlength="50" <?php echo htmlspecialchars($nom); ?>><br/>
        Prénom* : <input type="text" name="prenom" class="formulaireInsertion" required maxlength="50"<?php echo htmlspecialchars($prenom); ?>><br/>
        Date de Naissance* : <input type="date" name="dateNaissance" class="formulaireInsertion" required <?php echo htmlspecialchars($dateNaissance); ?>><br/>
        Taille (en cm) : <input type="number" placeholder="ex : 180" name="taille" class="formulaireInsertion" min="0" max="999" <?php echo htmlspecialchars($taille); ?>><br/>
        Poids : <input type="number" placeholder="ex : 80.00" name="poids" class="formulaireInsertion" min="0" max="999.99" step="0.01" <?php echo htmlspecialchars($poids); ?>><br/>
        ...
        Commentaire : <input type="text" name="commentaire" class="formulaireInsertion" maxlength="250" <?php echo htmlspecialchars($commentaire); ?>><br/>
